...
/*        User pets = new User("Pets", 1000000, handler);
        ...
        //TESTING SHORT FORM OF JSON:
        String masterAsString = new Gson().toJson(masterPortfolio);
        System.out.println("MASTER AS STRING:" + masterAsString);

        Portfolio masterBackToPortfolio = new Gson().fromJson(masterAsString, Portfolio.class);
        System.out.println(masterBackToPortfolio.getStock("AAPL").getCurrentPrice());
        //System.out.println(masterBackToPortfolio.getTransactionsReport(handler));
